...
assert.equal(PLUGIN_UUID.split(".").length,4);assert.equal(manifest.UUID,PLUGIN_UUID);assert.equal(manifest.Version,"0.3.0");assert.equal(manifest.Actions[0].UUID,ACTION_UUID);
