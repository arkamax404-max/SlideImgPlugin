...
class DeliveryTests(unittest.TestCase):
    ...
    def test_delivered_profile_receipt_and_action_metadata(self):
        ...
        self.assertEqual(entry["Action"],"com.arkamax.ulanzi.imageslide.slideshow");self.assertEqual(entry["Plugin"],{"Name":"Image Slideshow","UUID":"com.arkamax.ulanzi.imageslide","Version":"0.4.0"})
...
''',encoding="utf-8")
    ...
    def test_packages_and_checksum_manifest_read_back(self):
        ...
        with zipfile.ZipFile(ROOT/(plugin_root+".zip")) as archive:
            ...
            manifest=json.loads(archive.read(plugin_root+"/manifest.json"));self.assertEqual(manifest["Version"],"0.4.0");self.assertEqual(manifest["Author"],"Santiago P\u00e9rez")
            for name in names:
