...
export class SetupService {
  ...
  boundRequest(binding,requireFresh=true,requireCurrentVersion=true){
    try{
      ...
      const supportedVersion=requireCurrentVersion?request?.pluginVersion===PLUGIN_VERSION:["0.2.0","0.3.0","0.3.1","0.3.2","0.5.0","0.5.1","0.6.0","0.7.0","0.7.1",PLUGIN_VERSION].includes(request?.pluginVersion);
